function create_answer_option_in_new_question(){
    $('#modal_window_for_new_question .inner-modal-window .container-answer-option').append(`
            ...
            $('#input-create-answer').parent().html(`
                ...
                <div class="action-buttons-in-item">
                    <label style="color: red;">
                        ...
                        <input name="new_question" value=${$('#input-create-answer').val()} type="radio"/>
                    </label>
                ...
                $('#modal_window_for_new_question .inner-modal-window .container-answer-option .item-answer-option .action-buttons-in-item').last().on("click",'.edit',edit_answer_option_new_question);
                $('#modal_window_for_new_question .inner-modal-window .container-answer-option .item-answer-option .action-buttons-in-item').last().on("click",'.del',delete_answer_new_question);
                $('#modal_window_for_new_question .inner-modal-window .container-answer-option .item-answer-option label').last().on('click','input',changing_true_answer_new_question);
